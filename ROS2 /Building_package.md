...
- Create a directory inside this workspace named src 'mkdir src' 
...
- Inside the setup.py file in the package, change entry_points, console_scripts '["**node program name** = **package_name.node_name:main**"]
